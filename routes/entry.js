...
const {createEntry,likeEntry,dislikeEntry,undoLikeEntry,undoDislikeEntry,editEntry,favoriteEntry,hideEntry, visibleEntry,getEntriesBySlug} = require("../controllers/entry");

router.get("/", getEntriesBySlug);
