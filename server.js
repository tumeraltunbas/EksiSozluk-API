...
const fileUpload = require("express-fileupload"); //importing file upload package
...
app.use(fileUpload({limits: {fileSize: 50*1024*1024}})); //use fileUpload middleware and max limit of the file
